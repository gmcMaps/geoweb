function addEdificiosCapa() {
    ...
    map.addSource("edificios_source", {
        "type": "vector",
        "url": "mapbox://gemmamontane4.d9kp5ra5"  // mapbox://Nuestor ID Tileset
    ...
    "source-layer": "construcciones-5fsq9v", // Nuestro nombre Tileset
    "maxzoom": 21,
    "minzoom": 15,
    "filter": [">", "numberOfFl", 0], // Elimina las parcelas de altira 0
    "paint": {
...
//Nueva funcion!! (es para el slider del mapa de alturas, del cadastro)
